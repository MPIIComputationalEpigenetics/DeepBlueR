...
|                 | wait_request       | Wait for a request be processed                   |
...
request_info = wait_request(request_id = request_id)
...
cpgs = deepblue.select_annotations(annotation_name="Cpg Islands", genome="hg19")
