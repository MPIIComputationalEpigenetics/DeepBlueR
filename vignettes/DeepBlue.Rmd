http://veja.abril.com.br/noticia/brasil/bolsonaro-defende-torturador-e-jean-willys-cospe-nele---
...
gtrack <- GenomeAxisTrack()
itrack <- IdeogramTrack(genome = "hg38", chromosome = "chr1")
dtrack <- DataTrack(regions, "@CALCULATED(return math.log(value_of('@AGG.MEAN')))", name = "Log of average methylation value")
