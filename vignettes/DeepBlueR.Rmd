...
|          | export_meta_data      | Export meta data to a tab delimited file          |
...
# Large-scale analysis of DNA methylation across 212 samples from the 
...
Each of these files has a column that holds the DNA methylation beta values. 
There are two possibilities to select this column across several files.
