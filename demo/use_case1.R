...
#deepblue.select_regions takes 11 parameters as input, namely; 
...
sel_regions = deepblue.select_regions(genome ='GRCh38',
...
#deepblue.query_experiment_type takes 3 input parameters, namely; 
...
#deepblue.select_annotations takes 6 input parameters, namely; 
#annotation_name, genome, chromosome, start, end, and user_key. 
#All values are set to NULL as default.
promoters = deepblue.select_annotations(annotation_name ='promoters',
                                        genome ='GRCh38',
                                        chromosome ='chr1')
...
#deepblue.intersection takes 3 parameters as input, namely; 
#query_a_id, query_b_id, and user_key.
...
#deepblue.get_regions expects 3 input parameters; 
#query_id, output_format, and user_key."
req_regions = deepblue.get_regions(
    query_id =sel_tf,
